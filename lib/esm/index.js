...
var TestButton = function (_a) {
    var props = __rest(_a, []);
    return (React.createElement("button", __assign({}, props, { style: __assign({ width: 200, height: 60, color: "magenta", backgroundColor: "#FFFFFF", border: "2px solid magenta", borderRadius: 9 }, props.style) }), props.label));
};
