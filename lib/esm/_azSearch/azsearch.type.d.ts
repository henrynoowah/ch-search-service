import { FacetResult, GeographyPoint, QueryType, SearchMode } from "@azure/search-documents";
...
export declare type AzureSearchFacetModel = {
    [propertyName: string]: FacetResult[];
};
declare type FacetSort = "count" | "-count" | "value" | "-value";
...
export declare type SearchSelectOption = string;
...
export declare type SearchResults = (HospitalDocument | DoctorDocument | DealDocument | SpecialtyDocument | DepartmentDocument | HospitalSpecialtyDocument | ArticleDocument | ServiceDocument | ContributorDocument | CountryDocument | FaqDocument | FaqCategoryDocument)[];
