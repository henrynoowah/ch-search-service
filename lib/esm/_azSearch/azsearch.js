...
import { Idx, } from "./azsearch.type";
import { generateFacets, normalizeFilterValue } from "./helpers";
export var azsearch = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    searchClient = new SearchClient(az_search_endpoint, "idx-".concat(idx, "-").concat(stage), new AzureKeyCredential(az_search_key));
                    filter = getFilterString(options.filters, idx);
                    facets = facetDefinition && generateFacets(facetDefinition);
                    ...
                    switch (propertyName) {
                        case "Id":
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " Id eq '").concat(normalizeFilterValue(value), "'");
                            });
                            break;
                        case "ConsultationFee":
                            values.forEach(function (value, index) {
                                filterItem = "".concat(filterItem, " ").concat(index > 0 ? "or" : "", " ConsultationFee ").concat(value === "0" ? "eq" : "lt", " ").concat(normalizeFilterValue(value));
                            });
                            break;
                        case "ConsultationEnabled":
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " ConsultationEnabled eq ").concat(normalizeFilterValue(value));
                            });
                            break;
                        case "MarketingType":
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " MarketingType eq '").concat(normalizeFilterValue(value), "'");
                            });
                            break;
                        case "Location/Point":
                        ...
                        case "Country/Id":
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " Country/Id eq '").concat(normalizeFilterValue(value), "'");
                            });
                            break;
                        case "Translations/LanguageCode":
                            filterItem = "".concat(filterItem, " Translations/any(translation:");
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " translation/LanguageCode eq '").concat(normalizeFilterValue(value), "')");
                            });
                            break;
                        case "Translations/IsConfirmed":
                            filterItem = "".concat(filterItem, " Translations/any(translation:");
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " translation/IsConfirmed eq ").concat(normalizeFilterValue(value), ")");
                            });
                            break;
                        default:
                            filterItem = "";
                ...
                Object.keys(filters).forEach(function (propertyName) {
                    ...
                    if (values.length > 0) {
                        ...
                        switch (propertyName) {
                            case "Hospital/Id":
                                values.forEach(function (value, index) {
                                    filterItem_1 = "".concat(filterItem_1, " ").concat(index > 0 ? "or" : "", " Hospital/Id eq '").concat(normalizeFilterValue(value), "'");
                                });
                                break;
                            case "ConsultationFee":
                                values.forEach(function (value, index) {
                                    filterItem_1 = "".concat(filterItem_1, " ").concat(index > 0 ? "or" : "", " ConsultationFee ").concat(value === "0" ? "eq" : "lt", " ").concat(normalizeFilterValue(value));
                                });
                                break;
                            case "ConsultationEnabled":
                                values.forEach(function (value) {
                                    filterItem_1 = "".concat(filterItem_1, " ConsultationEnabled eq ").concat(normalizeFilterValue(value));
                                });
                                break;
                            case "Hospital/MarketingType":
                                values.forEach(function (value) {
                                    filterItem_1 = "".concat(filterItem_1, " Hospital/MarketingType eq '").concat(normalizeFilterValue(value), "'");
                                });
                                break;
                            case "Hospital/CountryId":
                                values.forEach(function (value) {
                                    filterItem_1 = "".concat(filterItem_1, " Hospital/CountryId eq '").concat(normalizeFilterValue(value), "'");
                                });
                                break;
                            case "Translations/LanguageCode":
                                filterItem_1 = "".concat(filterItem_1, " Translations/any(translation:");
                                values.forEach(function (value) {
                                    filterItem_1 = "".concat(filterItem_1, " translation/LanguageCode eq '").concat(normalizeFilterValue(value), "')");
                                });
                                break;
                            case "Translations/IsConfirmed":
                                filterItem_1 = "".concat(filterItem_1, " Translations/any(translation:");
                                values.forEach(function (value) {
                                    filterItem_1 = "".concat(filterItem_1, " translation/IsConfirmed eq ").concat(normalizeFilterValue(value), ")");
                                });
                                break;
                            default:
                                filterItem_1 = "";
            ...
            case Idx.deals:
                ...
                Object.keys(filters).forEach(function (propertyName) {
                    ...
                    switch (propertyName) {
                        case "Hospital/Id":
                            values.forEach(function (value, index) {
                                filterItem = "".concat(filterItem, " ").concat(index > 0 ? "or" : "", " Hospital/Id eq '").concat(normalizeFilterValue(value), "'");
                            });
                            break;
                        case "MarketingType":
                            values.forEach(function (value) {
                        ...
                        case "Hospital/CountryId":
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " Hospital/CountryId eq '").concat(normalizeFilterValue(value), "'");
                            });
                            break;
                        case "Translations/LanguageCode":
                            filterItem = "".concat(filterItem, " Translations/any(translation:");
                ...
                Object.keys(filters).forEach(function (propertyName) {
                    ...
                    switch (propertyName) {
                        ...
                        case "Translations/Name":
                            filterItem = "".concat(filterItem, " Translations/any(translation:");
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " translation/Name eq '").concat(normalizeFilterValue(value), "')");
                            });
                            break;
                        case "Translations/IsConfirmed":
                            filterItem = "".concat(filterItem, " Translations/any(translation:");
                ...
                Object.keys(filters).forEach(function (propertyName) {
                    ...
                    switch (propertyName) {
                        case "Hospitals/Id":
                            ...
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " hospital/Id eq '").concat(normalizeFilterValue(value), "')");
                            });
                            break;
                        case "Translations/LanguageCode":
                            filterItem = "".concat(filterItem, " Translations/any(translation:");
                        ...
                        case "Department/MarketingType":
                            values.forEach(function (value) {
                                filterItem = "".concat(filterItem, " Department/MarketingType eq '").concat(normalizeFilterValue(value), "'");
                            });
                            break;
                        case "Translations/LanguageCode":
                            filterItem = "".concat(filterItem, " Translations/any(translation:");
